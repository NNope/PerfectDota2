...
#pragma mark NSObject中的ID属性对应着字典中的id
    [PDNewsModel mj_setupReplacedKeyFromPropertyName:^NSDictionary *{
        return @{
                 @"ID" : @"id"
                 };
    }];
    [PDAuthorModel mj_setupReplacedKeyFromPropertyName:^NSDictionary *{
        return @{
                 @"ID" : @"id"
                 };
    }];
...
#pragma mark MJStatusResult类中的ads数组中存放的是MJAd模型
    [PDCityModel mj_setupObjectClassInArray:^NSDictionary *{
        return @{
                 @"arealist" : @"PDCityBaseModel", // @"statuses" : [MJStatus class],
                 };
    }];
    [PDProvinceModel mj_setupObjectClassInArray:^NSDictionary *{
        return @{
                 @"citylist" : @"PDCityModel", // @"statuses" : [MJStatus class],
                 };
    }];
